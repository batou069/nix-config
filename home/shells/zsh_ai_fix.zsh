fzf_ai_commands() {
  # Fix for "adaptive height is not compatible with top/bott" error
  # caused by global FZF_DEFAULT_OPTS containing margin/padding.
  # We reset FZF_DEFAULT_OPTS locally but keep some styling.
  local FZF_DEFAULT_OPTS="--border=rounded --info=inline --ansi"
