c = get_config()  # noqa: F821 - get_config is injected by IPython
...
c.TerminalInteractiveShell.llm_provider_class = (
    "my_providers.custom_gemini_provider.CustomGeminiProvider"
)
